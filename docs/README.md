...
This README serves as the documentation for the project. The project serves as a showcase of my ability to refactor code efficiently to increase extensibility and readability by applying SOLID and other software design principles.
